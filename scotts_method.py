...
class ScottsMethod:
    ...
    def remove_function_words(paragraphs):
        ...
        """
        return [
            [word for word in paragraph if word.lower() not in ScottsMethod.function_words]
    ...
    def replace_core_vocab_with_synonyms(paragraphs):
        ...
        for paragraph in paragraphs:
            ...
            for word in paragraph:
                ...
                if word_lower in ScottsMethod.core_vocab_words:
    ...
    def compare_texts(text1, text2):
        ...
        paragraphs1 = ScottsMethod.text_to_paragraphs(text1)
        paragraphs2 = ScottsMethod.text_to_paragraphs(text2)

        # Step 2: Remove common words; they don't add much to a text's meaning.
        paragraphs1 = ScottsMethod.remove_function_words(paragraphs1)
        paragraphs2 = ScottsMethod.remove_function_words(paragraphs2)

        # Step 3: Replace medium-frequency words with synonyms
        paragraphs1 = ScottsMethod.replace_core_vocab_with_synonyms(paragraphs1)
        paragraphs2 = ScottsMethod.replace_core_vocab_with_synonyms(paragraphs2)

        # Step 5: Initial large-scale check (compare most frequent words) across the whole of both texts
        most_freq_words_1 = ScottsMethod.most_frequent_words(paragraphs1)
        most_freq_words_2 = ScottsMethod.most_frequent_words(paragraphs2)
        ...
        most_freq_words_by_paragraph_1 = [ScottsMethod.most_frequent_words([paragraph]) for paragraph in paragraphs1]
        most_freq_words_by_paragraph_2 = [ScottsMethod.most_frequent_words([paragraph]) for paragraph in paragraphs2]
